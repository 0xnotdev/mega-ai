...
from mega_ai.observability.tracer import log_span
...
async def orchestrator_node(
    ...
    await emit(
        ...
        {
            "agent": "Orchestrator",
            "action": "deciding route"
        }
    )

    has_decomp = (
        state.get("decomposition_result")
        is not None
    )
...
async def synthesis_node(
    ...
    await emit(
        ...
        {
            "agent": "Synthesis",
            "action": "building provenance map"
        }
    )
